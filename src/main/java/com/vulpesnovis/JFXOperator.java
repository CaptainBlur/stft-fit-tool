...
public class JFXOperator {
    ...
    private @NotNull List<Node> drawAxis(int chartCanvasX, int chartCanvasY, short interfaceScaleFactor){
        ...
        final Text ordText = new Text("12345.6"); ordText.setFont(font);
        final Text absText = new Text("12345.6"); absText.setFont(font);
        final Text gradientText = new Text(" -123dB"); gradientText.setFont(gradFont);
    ...
    private class Ranges{
        ...
        public void setWindowSize(int windowWidth, int windowHeight) {this.windowWidth = windowWidth;this.windowHeight = windowHeight;}
...
//            else ySamplesInPixel = 1/yInterim;
    ...
    private class Buffer{
        ...
        private void setTransformParams(int SR, int fftSize, int winCount, int winSize) {sr = SR;this.fftSize = fftSize;this.winCount = winCount;this.winSize = winSize;}

        private void setMagnitudes(int magMin, int magMax){this.magMin = magMin;this.magMax = magMax;}

        private void setData(int[] timeValues, int[] freqValues, SparseIntArray fftDataset){this.timeValues = timeValues;this.freqValues = freqValues;this.fftDataset = fftDataset;}
    }
}
